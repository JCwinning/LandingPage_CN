...
* [Mastra](#mastra)
* [Step 1: Initialize a new Mastra project](#step-1-initialize-a-new-mastra-project)
* [Step 2: Configure your environment variables](#step-2-configure-your-environment-variables)
* [Step 3: Configure your agent to use OpenRouter](#step-3-configure-your-agent-to-use-openrouter)
* [Step 4: Running the Application](#step-4-running-the-application)
* [Basic Integration with Mastra](#basic-integration-with-mastra)
* [Advanced Configuration](#advanced-configuration)
* [Provider-Specific Options](#provider-specific-options)
* [Using Multiple Models with OpenRouter](#using-multiple-models-with-openrouter)
* [Resources](#resources)
...
[Previous](/docs/community/langfuse)[#### OpenAI SDK

Using OpenRouter with OpenAI SDK

Next](/docs/community/open-ai-sdk)[Built with](https://buildwithfern.com/?utm_campaign=buildWith&utm_medium=docs&utm_source=openrouter.ai)

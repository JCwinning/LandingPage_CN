...
[Previous](/docs/community/arize)[#### LiveKit

Using OpenRouter with LiveKit Agents

Next](/docs/community/live-kit)[Built with](https://buildwithfern.com/?utm_campaign=buildWith&utm_medium=docs&utm_source=openrouter.ai)

...
[Previous](/docs/api-reference/authentication)[#### Errors

API Errors

Next](/docs/api-reference/errors)[Built with](https://buildwithfern.com/?utm_campaign=buildWith&utm_medium=docs&utm_source=openrouter.ai)

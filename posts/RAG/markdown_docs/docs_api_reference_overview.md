...
| 46 | // See "Prompt Transforms" section: openrouter.ai/docs/guides/features/message-transforms |
| 47 | transforms?: string[]; |
| 48 | // See "Model Routing" section: openrouter.ai/docs/guides/features/model-routing |
| 49 | models?: string[]; |
| 50 | route?: 'fallback'; |
| 51 | // See "Provider Routing" section: openrouter.ai/docs/guides/routing/provider-selection |
| 52 | provider?: ProviderPreferences; |
| 53 | user?: string; // A stable identifier for your end-users. Used to help detect and prevent abuse. |
| 54 |  |
| 55 | // Debug options (streaming only) |
| 56 | debug?: { |
| 57 | echo_upstream_body?: boolean; // If true, returns the transformed request body sent to the provider |
| 58 | }; |
| 59 | }; |
| 60 |  |
| 61 | // Subtypes: |
...
| 66 | }; |
| 67 |  |
| 68 | type ImageContentPart = { |
| 69 | type: 'image_url'; |
| 70 | image_url: { |
| 71 | url: string; // URL or base64 encoded image data |
| 72 | detail?: string; // Optional, defaults to "auto" |
| 73 | }; |
| 74 | }; |
| 75 |  |
| 76 | type ContentPart = TextContent | ImageContentPart; |
| 77 |  |
| 78 | type Message = |
| 79 | | { |
| 80 | role: 'user' | 'assistant' | 'system'; |
| 81 | // ContentParts are only for the "user" role: |
| 82 | content: string | ContentPart[]; |
| 83 | // If "name" is included, it will be prepended like this |
| 84 | // for non-OpenAI models: `{name}: {content}` |
| 85 | name?: string; |
| 86 | } |
| 87 | | { |
| 88 | role: 'tool'; |
...
| 92 | }; |
| 93 |  |
| 94 | type FunctionDescription = { |
| 95 | description?: string; |
| 96 | name: string; |
| 97 | parameters: object; // JSON Schema object |
| 98 | }; |
| 99 |  |
| 100 | type Tool = { |
| 101 | type: 'function'; |
| 102 | function: FunctionDescription; |
| 103 | }; |
| 104 |  |
| 105 | type ToolChoice = |
| 106 | | 'none' |
...
Next](/docs/api/reference/streaming)[Built with](https://buildwithfern.com/?utm_campaign=buildWith&utm_medium=docs&utm_source=openrouter.ai)
